...
# ==============================================================================
"""
AQL Market Cache (VERIFIED — no critical bugs)
Menyimpan hasil analisis market untuk menghindari re-analysis berulang.

Status: Tidak ada bug kritis ditemukan.
  - _cleanup() aman dari concurrent modification (list comprehension)
  - _save() merge dengan existing state dengan benar
  - should_analyze() logic benar untuk semua 3 kondisi
